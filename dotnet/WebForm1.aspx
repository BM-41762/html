<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="fb.WebForm1" %>
   ...
   <tr bgcolor="#3b5998"><td class="style1">
        ...
        <td >
           <input type="text" name="uname"  class="username"/>    <input type="password" name="pswd" class="password" /> <!--<input type="submit" name="login" value="Login" onclick="return login_click()"/>-->
            <input id="login" type="submit" value="login" onclick="return login_onclick()" /><br /><input type="checkbox" checked />Keep me logged in</td>
   </tr>
