<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="fb.WebForm2" %>
...
<body>
 ...
 <form id="Form1" runat=server>   
  ...
  <div class="col-md-4"><pre id="pre1">Face Book Loggin....<hr id="hr1"  />
      ...
      <asp:Image ID="Image1"
          runat="server" Height="55px" ImageUrl="~/imgs/profile.png" Width="60px" /><asp:Label
              ID="uname" runat="server" Text="Haris Np"></asp:Label><br /><asp:HyperLink ID="Hlnk1"
                  runat="server">Not Haris?</asp:HyperLink> <br /><asp:Label ID="lblPswd" runat="server" Text="Password:"></asp:Label><asp:TextBox ID="pswd" runat="server" TextMode=Password></asp:TextBox><br />
...
<div id="divLast3" class="col-md-10"><asp:HyperLink ID="HyperLink2" runat="server">English (UK)</asp:HyperLink>  <asp:HyperLink ID="HyperLink3" runat="server">Malayalam</asp:HyperLink>  <asp:HyperLink ID="HyperLink4" runat="server">Telugu</asp:HyperLink>  <asp:HyperLink ID="HyperLink5" runat="server">Kannada</asp:HyperLink><br /><hr id="hr2"/><asp:HyperLink
    ...
    <asp:HyperLink ID="HyperLink8" runat="server">Terms</asp:HyperLink><br /><asp:Label ID="Label2"
        runat="server" Text="Face book(c)2016"></asp:Label><br /><asp:HyperLink ID="HyperLink9" runat="server">English (UK)</asp:HyperLink></div>
</div>
    </form>
</body>
</html>
